...
void compileType(void) {
  ...
  switch(lookAhead->tokenType){
    ...
    case(KW_FLOAT): eat(KW_FLOAT); break;
...
void compileExpression(void) {
  ...
  switch(lookAhead->tokenType){
    case(SB_PLUS): eat(SB_PLUS); compileExpression2();break;
    case(SB_MINUS): eat(SB_MINUS); compileExpression2(); break;
...
void compileExpression3(void) {
  // TODO
  switch(lookAhead->tokenType){
    case(SB_PLUS): eat(SB_PLUS); compileTerm(); compileExpression3();break;
    case(SB_MINUS): eat(SB_MINUS); compileTerm(); compileExpression3(); break;
    default: break;
  }
}
...
void compileTerm2(void) {
  // TODO
  switch(lookAhead->tokenType){
    case(SB_TIMES): eat(SB_TIMES); compileFactor(); compileTerm2();break;
    case(SB_SLASH): eat(SB_SLASH); compileFactor(); compileTerm2();break;
    default: break;
  }
}
